...
# jump_sound = pygame.mixer.Sound(os.path.join(snd_dir, 'laser.wav'))
        # pass=do nothing
...
#        draw_text(screen"High Score :" + str(self.highscore), 22, WHITE, WIDTH / 2, 40)
        draw_text(screen,str("You Tried!"), 70, WIDTH / 2, HEIGHT / 4 + 20)
        draw_text(screen,str("press the F key to continue.."), 40,  WIDTH / 2, HEIGHT - 60)
        # if score > highscore:
        #     highscore = score
    ...
    draw_text(screen,str("LEVEL 1"),24,WIDTH/2,10)
